...
/** Utility functions used by the Mnpro Qt UI.
 */
namespace GUIUtil
{
...
// Render Mnpro addresses in monospace font
...
// Parse "mnpro:" URI into recipient object, return true on successful parsing
