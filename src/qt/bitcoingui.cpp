                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Mnpro Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mnpro address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mnpro: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMNPR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mnpro Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mnpro Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mnpro"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mnpro addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mnpro addresses"));
    ...
    openAction->setStatusTip(tr("Open a Mnpro: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mnpro Core help message to get a list with possible Mnpro command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Mnpro Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mnpro network", "", count));
}
...
{
    QString strTitle = tr("Mnpro Core"); // default title
