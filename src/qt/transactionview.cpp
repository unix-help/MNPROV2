                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Rup from zMnpr"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMnpr"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMnpr));
