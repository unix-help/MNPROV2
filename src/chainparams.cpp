...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04a884418994c523f1437ea76961b65f9fe49e2f9f243c4f849f681ea70e972cb2664e8ceb77dfe38305194d0dc7c7d289723867954a94969dbcc7735c4d92e949");
        nDefaultPort = 3220;
       bnProofOfWorkLimit = ~uint256(0) >> 20;
        ...
        const char* pszTimestamp = "Chancellor on brink of second bailout for banks";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0487887de39dbfc64875dc3eabdb924d166fcfab4515d445bd068b5703ba2305fa0dc50e1653f687fe2338d8f30ea72ce36e3ef47ef84c2bb05576ac806dc59024") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1568570821;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1875503;
        
	    hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000951396e2ba426ce5abe7df021e991ce3d06eb4a217ea556002a4e0621a1"));
        assert(genesis.hashMerkleRoot == uint256("0xc49b4ab89bb06f288f78cfa9455027069b8c87e9b97cda283ca0bc71f1d35e1a"));
		
		vSeeds.push_back(CDNSSeedData("207.246.126.81", "207.246.126.81")); 
        vSeeds.push_back(CDNSSeedData("45.32.64.228", "45.32.64.228")); 
        ...
        strSporkKey = "045f65022cebac504addfeeb591c3cc4eba8f7938f88d4ae166e6af194c23cd45453bff1c47fedfbb777b6bd9013a8eac594c1cb4873de1026aa7b94e06e63b5cd";
...
public:
    CTestNetParams()
    {
        ...
        nTargetSpacing = 1 * 60;  // Mnpro: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.mnpr.io", "testnet.mnpr.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.mnpr.io", "testnet1.mnpr.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet.mnprocoin.org", "testnet.mnprocoin.org"));       // Single node address


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet mnpro addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet mnpro script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet mnpro BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet mnpro BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet mnpro BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nTargetSpacing = 1 * 60;        // Mnpro: 1 minutes
