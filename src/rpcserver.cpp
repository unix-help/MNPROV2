...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mnpro features */
        {"mnpro", "masternode", &masternode, true, true, false},
        {"mnpro", "listmasternodes", &listmasternodes, true, true, false},
        {"mnpro", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mnpro", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mnpro", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mnpro", "masternodedebug", &masternodedebug, true, true, false},
        {"mnpro", "startmasternode", &startmasternode, true, true, false},
        {"mnpro", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mnpro", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mnpro", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mnpro", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mnpro", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mnpro", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mnpro", "mnbudget", &mnbudget, true, true, false},
        {"mnpro", "preparebudget", &preparebudget, true, true, false},
        {"mnpro", "submitbudget", &submitbudget, true, true, false},
        {"mnpro", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mnpro", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mnpro", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mnpro", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mnpro", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mnpro", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mnpro", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mnpro", "checkbudgets", &checkbudgets, true, true, false},
        {"mnpro", "mnsync", &mnsync, true, true, false},
        {"mnpro", "spork", &spork, true, true, false},
        {"mnpro", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mnpro", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mnprod, or the -server option to mnpro-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mnpro-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3230/\n";
}
