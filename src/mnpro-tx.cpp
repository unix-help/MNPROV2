...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Mnpro Core mnpro-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mnpro-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mnpro transaction") + "\n" +
                               "  mnpro-tx [options] -create [commands]   " + _("Create hex-encoded mnpro transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mnpro transaction
