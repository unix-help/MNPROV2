Contributing to Mnpro Core
============================

The Mnpro Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Mnpro Core project, and is not to be
confused with overall Mnpro Network Protocol consensus changes.

Whether a pull request is merged into Mnpro Core rests with the project merge
...
Patches that change Mnpro consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mnpro consensus, it must have been
...
The project leader is the release manager for each Mnpro Core release.
